...
public class T_UbicacionFiscal implements java.io.Serializable {
     ...
     * the following description: Este atributo requerido sirve
     * para precisar la avenida, calle, camino o carretera donde se
     * da la ubicación.
     * 
     ...
     * requerido que sirve para asentar el código postal en donde
     * se da la ubicación.
     * 
     ...
     * the following description: Atributo requerido que sirve para
     ...
     * 'municipio' has the following description: Atributo
     * requerido que sirve para precisar el municipio o delegación
     * (en el caso del Distrito Federal) en donde se da la
     * ubicación.
     * 
     ...
     * following description: Este atributo requerido sirve para
     ...
     * has the following description: Atributo requerido que sirve
